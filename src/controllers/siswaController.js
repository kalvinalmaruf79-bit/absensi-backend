  ...
  try {
        ...
        case "tugas_dihapus":
          ...
          if (tugas) {
            detailResource = {
              ...
              data: {
                _id: tugas._id,
                judul: tugas.judul || null,
                deskripsi: tugas.deskripsi || null,
                deadline: tugas.deadline || null,
                mataPelajaran: tugas.mataPelajaran || null,
                guru: tugas.guru || null,
                kelas: tugas.kelas || null,
                semester: tugas.semester || null,
                tahunAjaran: tugas.tahunAjaran || null,
              },
            };
          }
          break;
          ...
          if (nilai) {
            detailResource = {
              ...
              data: {
                ...
                jenisPenilaian: nilai.jenisPenilaian || null,
                mataPelajaran: nilai.mataPelajaran || null,
                guru: nilai.guru || null,
                kelas: nilai.kelas || null,
                tugas: nilai.tugas || null,
                tanggalPenilaian: nilai.tanggalPenilaian || null,
        ...
        case "pengumuman_baru":
          ...
          if (pengumuman) {
            detailResource = {
              ...
              data: {
                _id: pengumuman._id,
                judul: pengumuman.judul || null,
                konten: pengumuman.konten || null,
                kategori: pengumuman.kategori || null,
                prioritas: pengumuman.prioritas || null,
                targetRole: pengumuman.targetRole || null,
                targetKelas: pengumuman.targetKelas || [],
                pembuat: pengumuman.pembuat || null,
                tanggalPublikasi: pengumuman.tanggalPublikasi || null,
                lampiran: pengumuman.lampiran || null,
              },
            };
          }
          break;
          ...
          if (jadwal) {
            detailResource = {
              ...
              data: {
                ...
                jamMulai: jadwal.jamMulai || null,
                jamSelesai: jadwal.jamSelesai || null,
                mataPelajaran: jadwal.mataPelajaran || null,
                guru: jadwal.guru || null,
    ...
    res.json({
      notifikasi: {
        ...
        resourceId: notifikasi.resourceId || null,
